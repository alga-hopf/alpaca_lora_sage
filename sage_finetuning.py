...
if __name__ == "__main__":
	...
	parser.add_argument('--wandb_project', default="", required=True, type=str, help="wandb project name")
	...
	parser.add_argument('--micro_batch_size', default=8, type=int, help="micro batch size")
